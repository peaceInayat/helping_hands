class ZonesController < ApplicationController
  before_action :set_zone, only: [:show, :edit, :update, :destroy, :get_all_orphanages]
  ...
  def get_all_orphanages
    @orphanages = @zone.orphanages.map{|u| Hash[value: "#{u.id}", name: u.email]}
    render json:@orphanages
  end
